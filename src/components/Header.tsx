            ...
            <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <ul className="hidden md:flex items center space-x-8 text-lg">
                    ...
                    <li className="group relative">
                        ...
                        <div className="absolute left-0 mt-2 w-56 bg-card rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2">
